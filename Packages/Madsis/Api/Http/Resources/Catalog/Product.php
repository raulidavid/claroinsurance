...
namespace Madsis\Api\Http\Resources\Catalog;

use Illuminate\Http\Resources\Json\JsonResource;
use Madsis\Product\Helpers\ProductType;
...
class Product extends JsonResource
{
    ...
    {
        $this->productImageHelper = app('Madsis\Product\Helpers\ProductImage');

        $this->productReviewHelper = app('Madsis\Product\Helpers\Review');
