...
use Madsis\Attribute\Models\Attribute;
use Madsis\Attribute\Models\AttributeOption;
use Madsis\BookingProduct\Models\BookingProduct;
use Madsis\BookingProduct\Models\BookingProductEventTicket;
use Madsis\Checkout\Models\Cart;
use Madsis\Checkout\Models\CartAddress;
use Madsis\Checkout\Models\CartItem;
use Madsis\Customer\Models\Customer;
use Madsis\Customer\Models\CustomerAddress;
use Madsis\Product\Models\Product;
use Madsis\Product\Models\ProductAttributeValue;
use Madsis\Product\Models\ProductDownloadableLink;
use Madsis\Product\Models\ProductDownloadableLinkTranslation;
use Madsis\Product\Models\ProductInventory;
...
class Laravel5Helper extends Laravel5
{
     ...
     *
     * @return \Madsis\Product\Models\Product
     * @part ORM
     */
    ...
    private function createAttributeValues(Product $product, array $attributeValues = []): void
    {
        ...
        if (! AttributeOption::query()
            ...
            AttributeOption::create([
                'admin_name'   => 'Madsis Demo Brand (c) 2020',
