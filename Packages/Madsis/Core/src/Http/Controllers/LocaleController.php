...
class LocaleController extends Controller
{
     ...
     *
     * @var \Madsis\Core\Repositories\LocaleRepository
     */
     ...
     *
     * @param  \Madsis\Core\Repositories\LocaleRepository  $localeRepository
     * @return void
     */
    ...
    public function store()
    {
        $this->validate(request(), [
            'code'      => ['required', 'unique:locales,code', new \Madsis\Core\Contracts\Validations\Code],
            'name'      => 'required',
    ...
    {
        $this->validate(request(), [
            'code'      => ['required', 'unique:locales,code,' . $id, new \Madsis\Core\Contracts\Validations\Code],
            'name'      => 'required',
            'direction' => 'in:ltr,rtl',
        ]);
