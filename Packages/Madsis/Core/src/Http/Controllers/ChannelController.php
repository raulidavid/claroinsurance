...
class ChannelController extends Controller
{
     ...
     *
     * @var \Madsis\Core\Repositories\ChannelRepository
     */
     ...
     *
     * @param  \Madsis\Core\Repositories\ChannelRepository  $channelRepository
     * @return void
     */
    ...
    public function store()
    {
        $this->validate(request(), [
            'code'              => ['required', 'unique:channels,code', new \Madsis\Core\Contracts\Validations\Code],
            'name'              => 'required',
    ...
    {
        $this->validate(request(), [
            'code'              => ['required', 'unique:channels,code,' . $id, new \Madsis\Core\Contracts\Validations\Code],
            'name'              => 'required',
            'locales'           => 'required|array|min:1',
