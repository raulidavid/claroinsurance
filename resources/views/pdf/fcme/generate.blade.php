    ...
    <div id="content">
        ...
        <div class="page" style="font-size: 7pt">
            ...
            <table style="width: 100%; font-size: 8pt;">
                ...
                <tr>
                    <td colspan="3">Fecha de la Orden: <strong></strong></td>
                </tr>
                <tr>
                    <td colspan="3">Apellidos y Nombres del cliente: <strong></strong></td>
                    <td colspan="1">No. Cédula cliente: <strong></strong></td>
                </tr>
                <tr>
                    <td colspan="3">Dirección domiciliar del cliente: <strong></strong></td>
                    <td colspan="1">No: <strong></strong></td>
                    <td colspan="2">Calle Secundaria: <strong></strong></td>
                </tr>
                <tr>
                    <td colspan="3">Referencia del domicilio: <strong></strong></td>
                </tr>
                <tr>
                    <td colspan="3">Teléfonos del cliente: <strong></strong></td>
                    <td colspan="1">Celular1: <strong></strong></td>
                    <td colspan="1">Celular2: <strong></strong></td>
                    <td colspan="1">Convencional:<strong> </strong></td>
                </tr>
                <tr>
                    <td colspan="5">Correo electrónico del cliente: <strong></strong></td>
                </tr>
                <tr>
                    <td colspan="3">Nombre de la institución en la que trabaja: <strong></strong></td>
                </tr>
                <tr>
                    <td colspan="2">Dirección de la institución: <strong></strong></td>
                    <td colspan="1">No: <strong></strong></td>
                    <td colspan="2">Calle Secundaria: <strong></strong></td>
                </tr>
                <tr>
                    <td colspan="1">Provincia: <strong></strong></td>
                    <td colspan="1">Cantón: <strong></strong></td>
                    <td colspan="1">Parroquía: <strong></strong></td>
                </tr>
                <tr>
                    <td colspan="2">Plazo del crédito: <strong>   <span style="margin-left: 45px">Meses</span></strong></td>
                </tr>
            ...
            <table class="change_order_items" style="width: 100%">
                ...
                <tbody><tr>
                    <td colspan="4" style="text-align: left;">Notas:</td>
            ...
            <table class="sa_signature_box">
                ...
                <tr>
                    <td rowspan="3" colspan="2" class="written_field"><span>Firma del Comprador/a</span></td>
                    <td rowspan="3" colspan="1"></td>
                    <td rowspan="3" colspan="2" class="written_field"><span>Firma del Intermediario Comercial</span></td>
                </tr>
