...
<div id="body">
        ...
        <tbody>
        <tr>
        <td><h1 style="text-align: left"><img class="logo-name" src="{{ asset('images/logos/logo.png') }}" alt=""></h1></td>
        <td><h1 style="text-align: right"><img class="logo-name" src="{{ asset('images/logos/fcme.png') }}" alt=""></h1></td>
        </tr>
        </tbody>
        </table>
        </div>
        ...
        <div id="content">
                ...
                <div class="page" style="font-size: 7pt">
                        ...
                        <table style="width: 100%; font-size: 8pt;">
                                <tbody>
                                <tr>
                                        <td><h1 style="text-align: left">ORDEN DE COMPRA No. <span style="color:red;">14893</span></h1></td>
                                </tr>
                                <tr>
                                        <td>Fecha: <strong>02/08/2019</strong></td>
                                </tr>
                                <tr>
                                        <td>Apellidos y nombres del cliente: <strong>Flores Serrano Raúl David</strong></td>
                                        <td>No. cédula cliente: <strong>1722500962</strong></td>
                                </tr>
                                <tr>
                                        <td>Dirección domiciliar del cliente: <strong>MARIA ANGELICA HIDROVO</strong></td>
                                        <td>Calle Secundaria: <strong>LEOPOLDO CHAVEZ</strong></td>
                                </tr>
                                <tr>
                                        <td>Referencia del domicilio: <strong>Frente a casas de pedro</strong></td>
                                        <td>Correo electrónico del cliente: <strong>raulidavid@hotmail.com</strong></td>
                                </tr>
                                <tr>
                                        <td>Provincia: <strong>Pichincha</strong></td>
                                        <td>Ciudad: <strong>Quito</strong></td>
                                </tr>
                                <tr>
                                        <td>Plazo: <strong>36 Meses</strong></td>
                                </tr>
                        ...
                        <table class="change_order_items">
                                ...
                                <tr class="even_row">
                                        ...
                                        <td style="text-align: center">MM900JBL31</td>
                                ...
                                <tbody><tr>
                                        <td colspan="3" style="text-align: left;">Notas:</td>
                                        <td colspan="2" style="text-align: right;"><strong>SubTotal:</strong></td>
                                        <td class="change_order_total_col">$7560.00</td></tr>
                                        <tr>
                                        <td colspan="3"></td>
                                        <td colspan="2" style="text-align: right;"><strong>Envío:</strong></td>
                                        <td class="change_order_total_col">$60.00</td></tr>
                                        <tr>
                                        <td colspan="3"></td>
                                        <td colspan="2" style="text-align: right;"><strong>Impuestos:</strong></td>
                                        <td class="change_order_total_col">$360.00</td></tr>
                                        <tr>
                                        <td colspan="3"></td>
                                        <td colspan="2" style="text-align: right;"><strong>Descuento:</strong></td>
                                        <td class="change_order_total_col">$10.00</td></tr>
                                        <tr>
                                        <td colspan="3"></td>
                                        <td colspan="2" style="text-align: right;"><strong>Total:</strong></td>
                                        <td class="change_order_total_col">$7430.00</td></tr>
                                </tbody></table>
                        ...
                        <table class="sa_signature_box">
                                ...
                                <tbody>
                                <tr>
                                        <td></td><td class="written_field" style="padding-left: 2.5in">&nbsp;</td>
                                        <td style="padding-left: 1em"></td><td class="written_field" style="padding-left: 2.5in; text-align: right;"></td>
                                </tr>
                                <tr>
                                        <td colspan="3" style="text-align: center;padding-top: 0em">Mr. Leland Palmer</td>
