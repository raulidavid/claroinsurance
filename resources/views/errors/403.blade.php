...
@section('title','403 Error')<!--Cambiamos el título de la página-->
...
@section('content')
    <div class="middle-box text-center animated fadeInDown">
    	...
    	<h2 class="font-bold">Página No Autorizada</h2>
        <h1>403</h1>
        <div class="error-desc">
            Lo sentimos, pero la página que estás intentando acceder ha sido denegada. Prueba a comprobar la URL de error, luego pulsa el botón de actualización en tu navegador o intenta encontrar algo más en nuestra aplicación.
        </div>
        <br>
